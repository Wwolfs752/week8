...
class ShipWindow(arcade.Window):
    ...
    def setup(self):
        ...
        self.sound = arcade.load_sound(":resources:sounds/coin3.wav")
        self.dump_sound = arcade.load_sound(':resources:sounds/rockHit2.ogg')
    ...
    def on_update(self, delta_time):
        collided_gold = arcade.check_for_collision_with_list(self.ship, self.goals)
        if collided_gold:
